...
- [ ] Task 5: `emitWheel` — тор вместо брусков. (зависит от 3, 4)
...
- [ ] Task 6: Торпедо с валиком и стыками. (зависит от 3)
...
- [ ] Task 7: Приборы картинками. (зависит от 2)
...
- [ ] Task 8: Дефлекторы и мелочь. (зависит от 6)
...
- [ ] Task 9: Стойки, поперечина, потолок. (зависит от 3, 4)
...
- [ ] Task 10: Карты дверей и сиденья. (зависит от 4)
...
### Phase 5: Финал (≈1 ч)
- [ ] Task 11: Перф и мобильный. (зависит от 5, 8, 10)
...
- [ ] Task 12: Документация и доска. (зависит от 11)
